...
const $$A = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Ghost" }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", " ", `<center> <br> <br> <br> <br> <p class="ex2" style="animation: fadeIn 2s;">Ap<x>p</x>s</p> <p>You can request games on the <a href="https://discord.gg/dbyDXfs5dN">Dis<x>co</x>rd serv<x>er</x></a></p> <div class="acontainer" id="acontainer"></div> </center> <script> 
...
}, "/home/nobodycares/Downloads/ghost-astro/src/pages/a.astro", void 0);

const $$file = "/home/nobodycares/Downloads/ghost-astro/src/pages/a.astro";
const $$url = "/a";
