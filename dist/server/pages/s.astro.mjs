...
const $$S = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Ghost" }, { "default": ($$result2) => renderTemplate(_a || (_a = __template([" ", '<div id="particles-js" style="z-index: -1;"></div> ', ` <center> <br> <br> <br> <br> <p class="ex2" style="animation: fadeIn 1s;">Settings</p> <div class="settingsdisplay" style="animation: fadeIn 1s;"> <div class="settingspanel"> <center> <h1>Themes</h1> <button class="button1" onclick="theme1()">Catppuccin</button> <button onclick="theme2()" class="button1">Ghost</button> <button onclick="theme4()" class="button1">Pink (Light)</button> <button onclick="theme5()" class="button1">Blue (Light)</button> <button onclick="theme6()" class="button1">Green (Light)</button> <button onclick="theme7()" class="button1">Green (Dark)</button> <button onclick="theme8()" class="button1">Pink (Dark)</button> <button onclick="theme9()" class="button1">Blue(Dark)</button> <button onclick="theme10()" class="button1">Purple</button> </center> </div> <div class="settingspanel"> <center> <h2>Cloak</h2> <button class="button1" onclick="icondocs()">Google Docs</button> <button class="button1" onclick="icondrive()">Google Drive</button> <button class="button1" onclick="icondesmos()">Desmos</button> <button class="button1" onclick="iconcanvas()">
Canvas</button> <button class="button1" onclick="iconclass()">
Google Classroom</button> </center> </div> <div class="settingspanel"> <center> <h2>Anti Tab Close</h2> <label class="switch"> <input type="checkbox" id="close"> <span class="slider round" onclick="noleave()"></span> </label> <h1>Panic Key</h1> <button class="button1" onclick="recordkey()">Record Key</button> </center> </div> <div class="settingspanel"> <center> <h2>Search Engine</h2> <select class="engines" id="engineSWITCHER"> <option value="https://www.google.com/search?=">Google</option> <option value="https://www.bing.com/search?form=&q=">Bing</option> <option value="https://duckduckgo.com/?t=h_&q=">DuckDuckGo</option> <option value="https://search.brave.com/search?q=">Brave</option> </select> </center> </div> <div class="settingspanel"> <center> <h2>Auto About:Blank</h2> <label class="switch"> <input type="checkbox" id="abt"> <span class="slider round" onclick="abt()"></span> </label> <h2>Click Off Tab Cloaking</h2> <label class="switch"> <input type="checkbox" id="clickoff"> <span class="slider round" onclick="clickoff()" id="cloak"></span> </label> </center> </div> <script src="/js/cosmos.js?req=8bd2s-aj3m&id=8fba1md-km28xz"><\/script> <script>
            ...
            <\/script> </div> </center> `])), maybeRenderHead(), renderComponent($$result2, "Nav", $$Nav, { "body": "", "href": "", "title": "" })) })}`;
