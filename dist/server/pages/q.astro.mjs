...
const $$Q = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(['<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200">', `<script>
    ...
    win.document.body.appendChild(iframe);
      ...
      <\/script>`])), renderComponent($$result, "Layout", $$Layout, { "title": "Google Classroom" }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<button class="barbutton" id="barButton" onclick="openTopbar()"><span class="material-symbols-outlined">arrow_downward</span></button><div class="topbar" id="topbar" style="color: black;"><div class="topbar-content"><button class="topbtn" id="topbttn" onclick="closeTopbar()"><span class="material-symbols-outlined" style="color: var(--Symbols-Color)"> arrow_upward </span></button><button class="topbtn" id="panelbttn" onclick="openswitchpanel()"><span class="material-symbols-outlined" style="color: var(--Symbols-Color)"> page_info </span></button><button class="topbtn" id="fwdbttn" onclick="forward()" style="left: 10px;"><span class="material-symbols-outlined" style="color: var(--Symbols-Color);"> arrow_forward </span></button><button class="topbtn" id="rfshbttn" onclick="refresh()" style="left: 30px;"><span class="material-symbols-outlined" style="color: var(--Symbols-Color)"> refresh </span></button><button class="topbtn" id="bckbttn" onclick="back()" style="left: 30px;"><span class="material-symbols-outlined" style="color: var(--Symbols-Color)"> arrow_back </span></button><button class="topbtn" id="bckbttn" onclick="home()" style="left: 30px;"><span class="material-symbols-outlined" style="color: var(--Symbols-Color)"> home </span></button><input type="text" class="input" id="forminput" placeholder="Search Or Enter A URL.."></div></div><div class="hiddenuvpanel" id="uvpanel"><button class="copybttn" id="copybttn" onclick="copyurl()">Copy URL</button><button class="topbtn" id="opbttn" onclick="op()" style="left: 30px; margin-top: 10px;"><span class="material-symbols-outlined"> open_in_new </span></button></div><iframe class="mainiframe" id="frame"></iframe>` }));
}, "/home/nobodycares/Downloads/ghost-astro/src/pages/q.astro", void 0);

const $$file = "/home/nobodycares/Downloads/ghost-astro/src/pages/q.astro";
const $$url = "/q";
